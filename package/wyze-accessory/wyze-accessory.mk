...
define WYZE_ACCESSORY_INSTALL_TARGET_CMDS_FLOODLIGHT
	...
	$(INSTALL) -m 0755 -D $(WYZE_ACCESSORY_PKGDIR)/files/floodlight_ctl_d $(TARGET_DIR)/usr/sbin/floodlight_ctl_d
	$(INSTALL) -m 0755 -D $(WYZE_ACCESSORY_PKGDIR)/files/floodlight_pir $(TARGET_DIR)/usr/sbin/floodlight_pir
	$(INSTALL) -m 0755 -D $(WYZE_ACCESSORY_PKGDIR)/files/S60floodlight_pir $(TARGET_DIR)/etc/init.d/S60floodlight_pir
	$(INSTALL) -m 0755 -D $(WYZE_ACCESSORY_PKGDIR)/files/S61floodlight_ctl_d $(TARGET_DIR)/etc/init.d/S61floodlight_ctl_d
